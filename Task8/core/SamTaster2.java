...
public class SamTaster2 {
	...
	public static void main(String[] args) {
		...
		// Доп. задание: создание экземпляра класcа через вызов статического метода с private конструктором
		Tester tester3 = Tester.newTester("Елена", "Еленова");
		tester3.setName("Михаил");
		tester3.setSurname("Сидоров");
